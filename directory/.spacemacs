...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(;;javascript
     ...
     ;; `M-m e R' (Emacs style) to install them.
     ;; ----------------------------------------------------------------
     ;;emacs-lisp
     ivy
     ;;helm
     ...
     (org :variables
          ...
          org-roam-directory "/home/alon/apps/orgnote/")
     ;; (shell :variables
...
;;  ;; 解决lsp下org插入python代码块添加新行卡顿问题
;;  (remove-hook 'python-mode-hook 'importmagic-mode)

  ;; org-mode下换行显示长行,并关闭小箭头的视觉线提示
  ;; 参考https://emacs.stackexchange.com/a/36967
  (defun org-line-wrap ()
  ...
  (if (display-graphic-p) (dolist (charset '(kana han cjk-misc bopomofo))
   (set-fontset-font (frame-parameter nil 'font) charset
                     (font-spec :family "WenQuanYi Zen Hei Mono" :size 24))))

  ;; python-mode下启用列指示器(column indicator)
  ;; 参考https://emacs.stackexchange.com/a/50583
  ;;(add-hook 'python-mode-hook 'display-fill-column-indicator-mode)


;;  ;; 设置imenu(类、函数、变量内容树)主题颜色
